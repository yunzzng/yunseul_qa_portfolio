  ...
  experience: [
    ...
    },
    {
      ...
      description: [
        ...
        "내정보지키미 글로벌의 자사 결제 시스템과 펫케어·쇼핑로그인의 신규 오픈 QA에 참여했습니다.",
    ...
    },
    {
      ...
      description: [
        "TL로서 팀 테스트 가이드를 작성하고 테스트 진행을 리딩했습니다.",
        "BM 상품의 기능과 적용 여부를 검증하고, 운영 로그 및 지표 로그를 확인했습니다.",
        "대만·글로벌 서비스의 현지화 품질 검증(LQA)을 수행했습니다.",
        "타사 MMORPG 플레이 테스트를 통해 벤치마킹하고, Unity 로컬 환경에서 수치를 비교하며 밸런스 테스트를 수행했습니다.",
      ],
    }
  ]
};
